# SuperFolio (13F 컨센서스 스크리너)

SEC EDGAR의 13F-HR 공시를 파싱해 유명 투자자(슈퍼인베스터)들의 포트폴리오를
교차 비교하는 한국형 Dataroma 스타일 스크리너. "이들이 가장 많이 겹쳐서 들고
있는 종목 / 가장 많이 산 종목 / 가장 많이 판 종목"을 보유자 수·합산 금액·평균
비중 순으로 본다. Home / Superinvestors / Grand Portfolio / S&P 500 Grid /
현재가 조회 5개 페이지로 구성된 멀티페이지 Streamlit 앱이다.
